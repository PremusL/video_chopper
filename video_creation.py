...
def chop_background(start: int, end: int,video_path: str, index: int = 0 ) -> None:
    video_choice = "bbswitzer-parkour.mp4"
    # video_path = "./joe_rogan_short.mp4"
    # try:
    ...
    with VideoFileClip(video_path) as video:
        ...
        new.write_videofile(f"./videos/clips/joe_rogan_short_{index}.mp4")
